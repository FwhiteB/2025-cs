...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->found((*reinterpret_cast< std::add_pointer_t<sin_record>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Widget::*)(sin_record )>(_a, &Widget::found, 0))
            return;
    }
}
...
// SIGNAL 0
void Widget::found(sin_record _t1)
{
